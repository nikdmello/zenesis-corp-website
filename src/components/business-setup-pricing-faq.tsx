    ...
    <section className="relative left-1/2 -mt-px w-screen -translate-x-1/2 bg-[#f5efe4] py-16 md:py-20">
      <div className="mx-auto w-full max-w-[100rem] px-6 md:px-12 xl:px-20">
        <div className="max-w-5xl">
          <h2 className="section-title max-w-3xl font-semibold text-[#11232a]">
            {title}
          </h2>
          <p className="mt-4 max-w-4xl text-[1.08rem] font-medium leading-8 text-[#11232a]/80">
            {description}
          </p>
          <p className="mt-5 max-w-4xl text-[0.98rem] font-medium leading-7 text-[#11232a]/66">
