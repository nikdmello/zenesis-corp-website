...
export const serviceDetailPages: Record<string, ServiceDetailConfig> = {
  mainland: {
    ...
    introBackgroundImageSrc: versionedAssetPath("/mainland.webp"),
  ...
  "free-zones": {
    ...
    introBackgroundImageSrc: versionedAssetPath("/freezone.webp"),
  ...
  offshore: {
    ...
    introBackgroundImageSrc: versionedAssetPath("/offshore.webp"),
  ...
  "document-attestation-services-in-uae": {
    ...
    backgroundImageSrc: versionedAssetPath("/document-attestation.webp"),
    backgroundImageAlt: "Professional document attestation support in the UAE",
    introBackgroundImageSrc: versionedAssetPath("/document-attestation.webp"),
    introBackgroundImageAlt: "Document attestation support background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[86%_36%]",
    overviewImageSrc: versionedAssetPath("/document-attestation.webp"),
  ...
  "open-a-bank-account-easily": {
    ...
    backgroundImageSrc: versionedAssetPath("/banking-support.webp"),
    backgroundImageAlt: "UAE business banking support and KYC planning",
    introBackgroundImageSrc: versionedAssetPath("/banking-support.webp"),
    introBackgroundImageAlt: "UAE business banking support background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[82%_30%]",
    overviewImageSrc: versionedAssetPath("/banking-support.webp"),
  ...
  "uae-company-visa": {
    ...
    backgroundImageSrc: versionedAssetPath("/company-visas.webp"),
    backgroundImageAlt: "Company visa support and residency planning in the UAE",
    introBackgroundImageSrc: versionedAssetPath("/company-visas.webp"),
    introBackgroundImageAlt: "Company visa support background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[80%_28%]",
    overviewImageSrc: versionedAssetPath("/company-visas.webp"),
  ...
  "corporate-tax-registration-in-the-uae": {
    ...
    backgroundImageSrc: versionedAssetPath("/corporate-tax-registration.webp"),
    backgroundImageAlt: "Corporate tax registration support and EmaraTax planning",
    introBackgroundImageSrc: versionedAssetPath("/corporate-tax-registration.webp"),
    introBackgroundImageAlt: "Corporate tax registration background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[84%_30%]",
    overviewImageSrc: versionedAssetPath("/corporate-tax-registration.webp"),
  ...
  "corporate-tax-filing-services-in-the-uae": {
    ...
    backgroundImageSrc: versionedAssetPath("/corporate-tax-filing.webp"),
    backgroundImageAlt: "Corporate tax filing support and annual return preparation",
    introBackgroundImageSrc: versionedAssetPath("/corporate-tax-filing.webp"),
    introBackgroundImageAlt: "Corporate tax filing background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[84%_30%]",
    overviewImageSrc: versionedAssetPath("/corporate-tax-return.webp"),
  ...
  "professional-bookkeeping-services-in-dubai": {
    ...
    backgroundImageSrc: versionedAssetPath("/bookkeeping.webp"),
    backgroundImageAlt: "Bookkeeping and financial reporting support in Dubai",
    introBackgroundImageSrc: versionedAssetPath("/bookkeeping.webp"),
    introBackgroundImageAlt: "Bookkeeping support background",
    introBackgroundImageMode: "ambient",
    introBackgroundImagePosition: "!object-[84%_30%]",
    overviewImageSrc: versionedAssetPath("/bookkeeping.webp"),
